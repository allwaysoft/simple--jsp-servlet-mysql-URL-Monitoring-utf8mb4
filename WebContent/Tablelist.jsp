                ...
                <div class="table-wrapper">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <%
                            ...
                            try {
                                Connection con1;
                                con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/surveysparrow?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC", "root", "root");
                            ...
                            try {
                                connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/surveysparrow?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC", "root", "root");

                                String sql = "select site_name,status,milliseconds,seconds,time from monitor_application where userid=?";
                                PreparedStatement preparedStatement = connection.prepareStatement("select site_name,status,milliseconds,seconds,time from monitor_application where userid=?");
